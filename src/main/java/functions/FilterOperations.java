...
public class FilterOperations {
    @AppBotCommand(name = "greyScale", description = "greyScale filter", showInHelp = true)
    ...
    @AppBotCommand(name = "onlyRed", description = "onlyRed filter", showInHelp = true)
    ...
    @AppBotCommand(name = "onlyGreen", description = "onlyGreen filter", showInHelp = true)
    ...
    @AppBotCommand(name = "onlyBlue", description = "onlyBlue filter", showInHelp = true)
